...
void main() {
  group('EngiMandalaWidget', () {
        ...
        MaterialApp(
          home: Scaffold(
            body: SizedBox(
              width: 400,
              height: 400,
              child: EngiMandalaWidget(isVisible: true),
            ),
          ),
        ),
      );
    ...
    testWidgets('should have CustomPaint for mandala rendering', (tester) async {
      ...
      expect(find.byKey(const Key('engi_mandala_custom_paint')), findsOneWidget);
    });
    ...
    testWidgets('should animate with active AnimationController', (tester) async {
      ...
      expect(find.byType(EngiMandalaWidget), findsOneWidget);
    });
    ...
    testWidgets('should be hidden when isVisible is false', (tester) async {
        ...
        MaterialApp(
          home: Scaffold(
            body: SizedBox(
              width: 400,
              height: 400,
              child: EngiMandalaWidget(isVisible: false),
            ),
          ),
        ),
      );
      ...
      expect(find.byKey(const Key('engi_mandala_custom_paint')), findsNothing);
    ...
    testWidgets('should have widget key for testing', (tester) async {
      ...
      expect(find.byKey(const Key('engi_mandala_widget')), findsOneWidget);
    });
    ...
    testWidgets('should use AnimatedBuilder for smooth animation loop',
      ...
      // EngiMandalaWidget の内部配下に AnimatedBuilder が存在する
