...
# パス設定
WORK_DIR="/home/horie/Takamagahara/utsushiyo/kozuchi"
...
echo "Generating new upload key for Kozuchi..."
...
keytool -genkeypair -v \
  ...
  -dname "CN=Takamagahara-Kozuchi, OU=Dev, O=Takamagahara, L=Tokyo, S=Tokyo, C=JP"
